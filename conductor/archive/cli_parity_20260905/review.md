# Post-implementation review: cli_parity_20260905
...
urllib automatic redirects bypassed the gate and scope. Redirects now re-enter the gated frontier. gzip/deflate bodies are decoded before archival header normalization. Duplicate query order, IPv6, semicolon paths and depth zero are preserved.
