# Post-implementation review: core_engine_politeness
...
Output pacing now reserves distinct slots; huge Retry-After values remain finite. The crawler remains single-flight.
...
- `tests/js/politeness_engine.test.js`
