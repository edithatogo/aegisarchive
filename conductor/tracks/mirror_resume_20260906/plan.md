...
- [x] T1 Define checkpoint schema and fault fixtures. (AC1, AC2)
...
- [x] T2 Persist CLI archive segments atomically. (AC1)
...
- [x] T3 Persist browser bytes and frontier together. (AC1, AC3)
...
- [x] T4 Implement verified resume and cancellation. (AC1, AC3)
...
- [x] T5 Implement conditional incremental refresh. (AC2)
  - **Files**: `cli/aegis_cli.py`, `web/lib/core_crawler.js`; focused tests: `tests/test_mirror_resume.py`; `tests/js/mirror_resume.test.js`.
...
- [x] T6 Resolve revisit lineage across segments. (AC2)
  - **Files**: `cli/mirror_checkpoint.py`, `web/lib/mirror_checkpoint.js`; focused tests: `tests/test_mirror_resume.py`; `tests/js/mirror_resume.test.js`.
...
- [x] T7 Exercise interruption and recovery matrix. (AC1, AC2, AC3)
