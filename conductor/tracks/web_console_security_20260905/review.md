# Post-implementation review: web_console_security_20260905
...
Raw HTML could open outside the sandbox; it is now downloaded. CSP precedes untrusted pre-head markup, refresh metadata is removed, frame src is reset, gzip inputs are decompressed, parser warnings are surfaced, default OPFS filenames are unique, and checkpoints cannot change profile or scope.
...
- `scripts/build_profile_bundle.py`
- `web/profiles.bundle.js`
- `tests/js/core_crawler_checkpoint.test.js`
