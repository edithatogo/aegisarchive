...
- [ ] T1 Specify fixture contracts and RED tests. (AC1–AC3)
  - **Files**: `cli/jobs.py`, `mcp/server.py`, `tests/test_headless_jobs.py`, `docs/HEADLESS_JOBS.md`.
  ...
  - **Verify**: `python3 -m unittest tests.test_headless_jobs`; `python3 scripts/gate.py test`; full Conductor validation. T1 records expected RED failures separately.
