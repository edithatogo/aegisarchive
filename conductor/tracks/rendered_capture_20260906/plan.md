...
- [x] T1 Specify adapter and rendered fixture contract. (AC1, AC3)
...
- [x] T2 Implement isolated browser lifecycle. (AC3)
  - **Files**: `optional/browser_capture/`; focused tests: `tests/browser/rendered_capture.spec.js`.
...
- [x] T3 Enforce subrequest scope and pacing. (AC2)
  - **Files**: `optional/browser_capture/`; focused tests: `tests/browser/rendered_capture.spec.js`.
...
- [x] T4 Implement bounded rendered interaction recipes. (AC1, AC2)
  - **Files**: `optional/browser_capture/`; focused tests: `tests/browser/rendered_capture.spec.js`.
...
- [x] T5 Implement opt-in login recipes. (AC2, AC3)
  - **Files**: `optional/browser_capture/`; focused tests: `tests/browser/rendered_capture.spec.js`.
...
- [x] T6 Write response and rendered derivative receipts. (AC1, AC3)
  - **Files**: `optional/browser_capture/`; focused tests: `tests/browser/rendered_capture.spec.js`.
...
- [x] T7 Qualify visible and headless platform runs. (AC1, AC2, AC3)
