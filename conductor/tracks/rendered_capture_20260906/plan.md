...
- [ ] T1 Specify fixture contracts and RED tests. (AC1–AC3)
  - **Files**: `optional/browser_capture/`, `tests/browser/rendered_capture.spec.js`, `docs/RENDERED_CAPTURE.md`.
  ...
  - **Verify**: `npx --no-install playwright test tests/browser/rendered_capture.spec.js`; `python3 scripts/gate.py test`; full Conductor validation. T1 records expected RED failures separately.
