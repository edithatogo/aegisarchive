...
- [x] T1 Define catalogue and derivative schemas. (AC1, AC2)
...
- [x] T2 Implement immutable registration and history. (AC2)
  - **Files**: `portable/document_catalogue.py`; focused tests: `tests/test_document_lifecycle.py`.
...
- [x] T3 Add bounded native text extraction. (AC1, AC3)
...
- [x] T4 Add optional PDF and Office adapters. (AC1, AC3)
...
- [x] T5 Add optional OCR derivative processing. (AC1, AC3)
  - **Files**: `portable/document_extract.py`, `optional/document_processing/`; focused tests: `tests/test_document_lifecycle.py`.
...
- [x] T6 Implement revision-aware offline search. (AC1, AC2)
...
- [x] T7 Implement revision changes and duplicates. (AC2)
...
- [x] T8 Enforce handling and retention boundaries. (AC3)
...
- [x] T9 Final acceptance and claim reconciliation. (AC1–AC3)
