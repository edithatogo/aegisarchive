...
- [ ] T1 Specify fixture contracts and RED tests. (AC1–AC3)
  - **Files**: `portable/document_catalogue.py`, `portable/document_extract.py`, `portable/document_search.py`, `tests/test_document_lifecycle.py`, `docs/DOCUMENT_LIFECYCLE.md`.
  ...
  - **Verify**: `python3 -m unittest tests.test_document_lifecycle`; `python3 scripts/gate.py test`; full Conductor validation. T1 records expected RED failures separately.
