...
- [x] T1 Define platform receipt contract. (AC1)
...
- [x] T2 Build capture-disconnect-replay harness. (AC1, AC2)
...
- [x] T3 Verify relocated ordinary launchers. (AC1, AC3)
...
- [x] T4 Add isolated platform acceptance CI. (AC1, AC2)
...
- [x] T5 Record actual Apple Silicon acceptance. (AC1, AC2)
  - **Files**: `scripts/mirroring_acceptance.py`; focused tests: `tests/browser/mirroring_acceptance.spec.js`.
...
- [x] T6 Record Windows acceptance. (AC1, AC2)
  - **Files**: `scripts/mirroring_acceptance.py`; focused tests: `tests/browser/mirroring_acceptance.spec.js`.
...
- [x] T7 Publish the scoped capability matrix. (AC3)
