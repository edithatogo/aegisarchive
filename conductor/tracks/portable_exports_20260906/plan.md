...
- [x] T1 Specify export mappings and adversarial fixtures. (AC2)
...
- [x] T2 Implement deterministic directory export. (AC1, AC2)
  - **Files**: `cli/export_mirror.py`; focused tests: `tests/test_mirror_export.py`; `tests/browser/export_acceptance.spec.js`.
...
- [x] T3 Add deterministic ZIP and readback. (AC2, AC3)
  - **Files**: `cli/export_mirror.py`; focused tests: `tests/test_mirror_export.py`; `tests/browser/export_acceptance.spec.js`.
...
- [x] T4 Specify WACZ/CDXJ format contract. (AC3)
...
- [x] T5 Implement and independently validate interoperable package. (AC3)
  - **Files**: `cli/export_mirror.py`; focused tests: `tests/test_mirror_export.py`; `tests/browser/export_acceptance.spec.js`.
...
- [x] T6 Qualify relocation and accessible offline use. (AC1, AC2)
...
- [x] T7 Document prerequisites and repair diagnostics. (AC3)
  - **Files**: `docs/PORTABLE_EXPORTS.md`; focused tests: `tests/test_mirror_export.py`; `tests/browser/export_acceptance.spec.js`.
...
- [x] T8 Final acceptance and claim reconciliation. (AC1–AC3)
