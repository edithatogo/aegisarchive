...
- [x] T1 Define session contracts and auth fixtures. (AC1, AC2)
...
- [x] T2 Load explicit local session material. (AC1, AC2)
...
- [x] T3 Enforce redirect credential isolation. (AC1, AC2)
...
- [x] T4 Detect login and session expiry. (AC1, AC3)
...
- [x] T5 Redact all secret-bearing artefacts. (AC2)
...
- [x] T6 Expose supported acquisition routes. (AC3)
